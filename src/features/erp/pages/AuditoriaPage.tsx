// Módulo de auditoría del panel ERP.
// Muestra el log de todas las acciones críticas del sistema
...
const accionStyle = (accion: string) =>
    ACCION_STYLES[accion] ?? "bg-slate-100 text-slate-600";
...
export const AuditoriaPage = () => {
    ...
    useEffect(() => { cargarAuditoria(); }, [entidad, limit]);
                                ...
                                <tbody>
                                    {registros.map((reg) => (
                                        <>
                                            ...
                                            >
                                                {/* Fecha */}
                                                <td className="border-b border-slate-200 px-4 py-3 text-xs text-slate-500 whitespace-nowrap">
                                                ...
                                                <td className="border-b border-slate-200 px-4 py-3">
                                                    ...
                                                    {reg.id_entidad && (
                                                        <span className="ml-1.5 text-xs text-slate-400">#{reg.id_entidad}</span>
                                                    )}
                                                </td>
                                                        ...
                                                        <div className="flex gap-6">
                                                            {reg.datos_anteriores && (
                                                                <div className="flex-1">
                                                                    ...
                                                                    <pre className="overflow-auto rounded-lg bg-white border border-slate-200 p-3 text-xs text-slate-700 max-h-40">
