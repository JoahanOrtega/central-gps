  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: CreateFuelCargaPayload = {
        ...
        grupo_unidades: unidadSeleccionada?.grupo_unidades || null, 
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(v) => !v && handleTryClose()}>
        <DialogContent className="max-w-3xl bg-white max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-slate-100 pt-4 bg-slate-50/50 p-3 rounded-xl border border-slate-100">
              <div>
      ...
      <ConfirmDialog 
        ...
        description="Si decides salir ahora, perderás la información ingresada." 
        confirmText="DESCARTAR CAMBIOS" 
        confirmButtonClassName="bg-amber-600 text-white" 
